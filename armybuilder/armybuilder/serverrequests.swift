...
func addArmy(army: Army) {  // функция добавления армии на бекенд
...
func loadCookies() -> Bool {  // функция проверки на наличие cookies
  guard
    let cookieArray = UserDefaults.standard.array(forKey: "savedCookies")
...
func updatearmy(army: Army) {  // функция обновления измененной армии на бекенде
...
func changearmyname(oldname: String, newname: String) {  // функция изменения названия армии на бекенде
...
func forgotPassword(email: String) {  // функция восстановления пароля
