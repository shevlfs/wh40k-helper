    ...
    var body: some View {
        ...
        VStack{
            HStack{
                ...
                Spacer()
                TextField("", text:
                            $Name).disabled(true).padding().foregroundColor(.white)
            ...
            HStack{
                ...
                Spacer()
                TextField("", text:
                            $Range).disabled(true).padding().foregroundColor(.white)
                    .frame(width: 150, height: 10)
                    .padding()
                    .background(
                        RoundedRectangle(cornerRadius: 8)
            ...
            HStack{
                ...
                Spacer()
                TextField("", text:
                            $S).disabled(true).padding().foregroundColor(.white)
                    .frame(width: 150, height: 10)
                    .padding()
                    .background(
                        RoundedRectangle(cornerRadius: 8)
            ...
            HStack{
                ...
                Spacer()
                TextField("", text:
                            $D).disabled(true).padding().foregroundColor(.white)
                    .frame(width: 150, height: 10)
                    .padding()
                    .background(
                        RoundedRectangle(cornerRadius: 8)
